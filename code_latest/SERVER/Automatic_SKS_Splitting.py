...
if machine=='local':   
    ...
    path = '/raid/home/srvx7/gerrit/Project_1/Data/SplitWave_Results/SKS/'
...
#        plt.plot(xdata, func(xdata, *popt), 'rx',label='prediction')
        ...
        plt.errorbar(xdata, ydata, xerr=perr[1]*180/np.pi, yerr=perr[0],color='red',alpha=0.5 ,label='errorbar', fmt='o')
